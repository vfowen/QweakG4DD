void dynam_pic_11()
{
  ...
  TCurlyLine *zb1 = new TCurlyLine(90.74+xmove, 54+ymove, 76.24+xmove, 74.5+ymove);
  zb1->SetWavy();
  zb1->Draw();
  
  /*  
  t.DrawLatex(40+xmove,48+ymove,"l");
  t.DrawLatex(40+xmove,40+ymove,"m");
  t.DrawLatex(40+xmove,30+ymove,"n");

  t.DrawLatex(120+xmove,48+ymove,"j");
  t.DrawLatex(120+xmove,40+ymove,"k");
  t.DrawLatex(120+xmove,30+ymove,"i");
  ...
  t.DrawLatex(27+xmove,40+ymove,"d(u)");
  t.DrawLatex(27+xmove,28+ymove,"u(d)");

  t.DrawLatex(133+xmove,51+ymove,"u(d)");
  t.DrawLatex(133+xmove,40+ymove,"d(u)");
  t.DrawLatex(133+xmove,28+ymove,"u(d)");
