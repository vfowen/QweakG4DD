/*
   ...
   \file QweakSimLumi_DetectorHit.hh
   \author Wade Duvall

*/

#ifndef QweakSimLumi_DetectorHit_h
#define QweakSimLumi_DetectorHit_h 1

#include "QweakSimHit.hh"

class QweakSimLumi_DetectorHit : public G4VHit {
    public:
        ...
        /*
         * CLEAN UP, stolen from other files (Cerenkov/LeadGlass)
         */
...
typedef G4THitsCollection<QweakSimLumi_DetectorHit> QweakSimLumi_DetectorHitsCollection;

extern G4Allocator<QweakSimLumi_DetectorHit>  QweakSimLumi_DetectorHitAllocator;

inline void* QweakSimLumi_DetectorHit::operator new(size_t) {
    void* aHit;
    aHit = (void*) QweakSimLumi_DetectorHitAllocator.MallocSingle();
    return aHit;
}

inline void QweakSimLumi_DetectorHit::operator delete(void* aHit) {
    QweakSimLumi_DetectorHitAllocator.FreeSingle((QweakSimLumi_DetectorHit*) aHit);
}
