...
#ifndef QweakSimUserLumi_DetectorEvent_h
#define QweakSimUserLumi_DetectorEvent_h
...
class QweakSimUserLumi_DetectorEvent : public TObject
{
...
};  // end class QweakSimUserLumi_DetectorEvent 
