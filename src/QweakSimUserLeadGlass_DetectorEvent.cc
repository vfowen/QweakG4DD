...
ClassImp(QweakSimUserLeadGlass_DetectorEvent)

/////// --------------------------------------------------------------------

QweakSimUserLeadGlass_DetectorEvent::QweakSimUserLeadGlass_DetectorEvent() 
{
...
void QweakSimUserLeadGlass_DetectorEvent::Initialize()
{
    //DetectorID                   = 0.0;
...
// void QweakSimUserLeadGlass_DetectorEvent::AddSecondaryElectronEvent(Float_t XO, Float_t YO, Float_t ZO,
