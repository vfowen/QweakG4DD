...
ClassImp(QweakSimUserPMTOnly_DetectorEvent)

/////// --------------------------------------------------------------------

QweakSimUserPMTOnly_DetectorEvent::QweakSimUserPMTOnly_DetectorEvent() 
{
...
void QweakSimUserPMTOnly_DetectorEvent::Initialize()
{
    //DetectorID                   = 0.0;
...
// void QweakSimUserPMTOnly_DetectorEvent::AddSecondaryElectronEvent(Float_t XO, Float_t YO, Float_t ZO,
