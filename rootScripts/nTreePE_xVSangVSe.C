...
double doAna(char *fn, double &l, double &dl, double &r, double &dr, int n)
{
  ...
  t->Project(Form("hl%d",n),"Cerenkov.PMT.PMTLeftNbOfPEs[3]","Cerenkov.PMT.PMTLeftNbOfPEs[3]>0 LnPMThit>0 && Cerenkov.PMT.PMTRightNbOfPEs[3]>0");
  t->Project(Form("hr%d",n),"Cerenkov.PMT.PMTRightNbOfPEs[3]","Cerenkov.PMT.PMTLeftNbOfPEs[3]>0 LnPMThit>0 && Cerenkov.PMT.PMTRightNbOfPEs[3]>0");
